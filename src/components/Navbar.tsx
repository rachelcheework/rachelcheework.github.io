...
const Navbar = () => {
  ...
  return (
    <nav>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed inset-0 z-20 flex flex-col w-full self-end min-h-screen py-1 pt-36 px-12 space-y-6 text-md text-gray-800 bg-white/70 backdrop-blur-xl transition-transform duration-700 ease-out
